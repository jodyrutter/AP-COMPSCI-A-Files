...
public class CO2FromWasteTester
{
   public static void main(String[] args)
   {
       ...
       cO2.add(new CO2FromWaste(4,true,false,false,true));
       cO2.add(new CO2FromWaste(7,true,true,false,true));
       cO2.add(new CO2FromWaste(1,true,false,false,true));
       cO2.add(new CO2FromWaste(7,true,true,true,true));
