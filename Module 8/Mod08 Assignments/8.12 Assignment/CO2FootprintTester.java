...
public class CO2FootprintTester
{
    public static void main(String[] args)
    {
        ...
        cO2.add(new CO2Footprint(1519.7, 328.18, 0.08, 4, 20, true, false, false, true));
        cO2.add(new CO2Footprint(1008.1, 26.70, 0.11, 1, 5, true, false, false, true));
        cO2.add(new CO2Footprint(1241.3, 190.71, 0.13, 3, 15, true, true, true, true));
        cO2.add(new CO2Footprint(319, 26.83, 0.11, 1, 5, true, true, true, true));
        cO2.add(new CO2Footprint(2321, 419.13, 0.07, 5, 0, false, false, false ,false));
