...
public class TestInventory8
{
    ...
    public static void changeItem(List<InventoryItem> list, 
    ...
    public static void insertItem1(List<InventoryItem> list, 
    ...
    public static void insertItem2(List<InventoryItem> list, 
    ...
    public static void deleteByLoc(List<InventoryItem> list, 
                                    int location) 
    {          
    ...
    public static void deleteByName(List<InventoryItem> list, 
                                    String find) 
    {
        int location = 0;
        int index;
