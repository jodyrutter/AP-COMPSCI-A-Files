/**
 * Class to convert between units of measurement using static methods.
 * 
 * @author: Jody Rutter
 * @version: 7/11/2015 v1.0
 */
public class MeasurementConverterV2Redo
{
//Purpose of program
    ...
    public static void main(String[ ] args)
    {
        ...
        double nauticalMiles = 721.7;
        miles = convertNauticalMilesToMiles(nauticalMiles);
        System.out.printf("%8.1f nm. = %7.1f mi. %n", nauticalMiles, miles);
        
        miles = 927.1;
        nauticalMiles = convertMilesToNauticalMiles(miles);
        System.out.printf("%8.1f mi. = %7.1f nm. %n", miles, nauticalMiles);
